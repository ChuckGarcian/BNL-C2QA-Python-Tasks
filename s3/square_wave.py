...
"""
1. To approximate a curve with discrete slopes rather then a nice continuous 
curved slopes, we need many terms. This is why we see many  frequencies

2. Throughout the interval 50 percent have a value of zero and the other 50 
percent have value 1. Which means the average value is .5


3. There are no sin components in it's DFT since it has even symmetry. 
